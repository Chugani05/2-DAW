<template>
  <div class="container text-center">
    ...
    <div class="mb-4">
      ...
      <select v-model="eventType" id="eventType" class="form-select">
        <option value="">Todos</option>
        <option value="muertes">Muertes</option>
        <option value="desapariciones">Desapariciones</option>
        <option value="paranormales">Fenómenos Paranormales</option>
      </select>
    </div>

    <div class="mb-3">
      <div v-for="(event, index) in filteredEvents" :key="index" class="card mb-3">
