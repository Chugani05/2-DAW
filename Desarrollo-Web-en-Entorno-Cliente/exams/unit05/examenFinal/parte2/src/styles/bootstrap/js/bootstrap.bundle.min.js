...
!(function (t, e) {
          ...
          T = (function () {
            ...
            return (
              ...
              (T._getItemIndex = function (e) {
                return (
                  (this._items = t.makeArray(t(e).parent().find(b.ITEM))), this._items.indexOf(e)
                )
              }),
              ...
              (s.show = function () {
                ...
                if (
                  ...
                  if ((t(this._element).trigger(s), !s.isDefaultPrevented())) {
                    e &&
                      (o._jQueryInterface.call(t(e).not(this._selector), 'hide'),
                      i || t(e).data(n, null))
                ...
                if (!this._isTransitioning && t(this._element).hasClass(h)) {
                  ...
                  if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                    ...
                    ;(this._element.style[i] = ''),
                      k.supportsTransitionEnd()
                        ? t(this._element).one(k.TRANSITION_END, a).emulateTransitionEnd(600)
                        : a()
                  }
                }
              }),
  ...
  function Q(t) {
    ...
    return n && 'BODY' !== n && 'HTML' !== n
      ? -1 !== ['TD', 'TABLE'].indexOf(e.nodeName) && 'static' === F(e, 'position')
        ? Q(e)
        : e
      : t
  ...
  function G(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(r))
      return 'BODY' === (a = (s = l).nodeName) || ('HTML' !== a && Q(s.firstElementChild) !== s)
        ? Q(l)
        : l
    var c = Y(t)
  ...
  function at(t, e, n, i) {
    ...
    if ('viewport' === i)
      ...
      var d = void 0
      'scrollParent' === i
        ? 'BODY' === (d = V(K(e))).nodeName && (d = t.ownerDocument.documentElement)
            ...
            var r = e.priority,
              ...
              s = {
                primary: function (t) {
                  var n = o[t]
                  return (
                    o[t] < i[t] && !e.escapeWithReference && (n = Math.max(o[t], i[t])),
                    nt({}, t, n)
                  )
                },
                secondary: function (t) {
                  ...
                  return (
                    o[t] > i[t] &&
                      ...
                      (r = Math.min(o[n], i[t] - ('right' === t ? o.width : o.height))),
                    nt({}, n, r)
                  )
                },
              }
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              ...
              (t.arrowElement = i),
              (t.offsets.arrow = (nt((n = {}), f, Math.round(E)), nt(n, u, ''), n)),
              t
            )
          },
          element: '[x-arrow]',
        ...
        et(t, [
          ...
          },
          {
            ...
            value: function () {
              return function () {
                this.state.eventsEnabled ||
                  (this.state = vt(this.reference, this.options, this.state, this.scheduleUpdate))
              }.call(this)
            },
          },
          {
          ...
          return (
                ...
                if ((s._clearMenus(), !n)) {
                  ...
                  if ((t(e).trigger(r), !r.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      var o = this._element
                      t(e).hasClass(f) &&
                        (t(this._menu).hasClass(g) || t(this._menu).hasClass(p)) &&
                        (o = e),
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                var i = t(this).data(n)
                if (
                  (i || ((i = new s(this, 'object' == typeof e ? e : null)), t(this).data(n, i)),
                  'string' == typeof e)
                ) {
              ...
              if (
                (/input|textarea/i.test(e.target.tagName)
                  ? !(
                      32 === e.which ||
                      (27 !== e.which &&
                        ((40 !== e.which && 38 !== e.which) || t(e.target).closest(E).length))
                    )
                  : a.test(e.which)) &&
            ...
            (g._showBackdrop = function (e) {
              ...
              if (this._isShown && this._config.backdrop) {
                ...
                k.supportsTransitionEnd() && t(this._element).hasClass(u)
                  ? t(this._backdrop).one(k.TRANSITION_END, o).emulateTransitionEnd(150)
                  : o()
              } else e && e()
            }),
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new s(this, r)), t(this).data(n, i)), 'string' == typeof e)
                ) {
                  if ('undefined' == typeof i[e]) throw new TypeError('No method named "' + e + '"')
                  i[e]()
                }
            ...
            (m._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new m(this, r)), t(this).data(n, i)), 'string' == typeof e)
                ) {
                  if ('undefined' == typeof i[e]) throw new TypeError('No method named "' + e + '"')
                  i[e]()
                }
          ...
          return (
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                var i = t(this).data(n)
                if (
                  (i || ((i = new s(this, 'object' == typeof e && e)), t(this).data(n, i)),
                  'string' == typeof e)
                ) {
                  if ('undefined' == typeof i[e]) throw new TypeError('No method named "' + e + '"')
                  i[e]()
